...
internal static class FontManager
{
    ...
    private static readonly Dictionary<IconSize, FontFamily> _fluent = IconSizeValues.Enumerable
        ...
        .ToDictionary(k => k, k => new FontFamily($"ms-appx:///Assets/FluentSystemIcons-{k}.otf#Fluent System Icons {k}"));
    ...
    private static readonly FontFamily _seagull = new($"ms-appx:///Assets/SeagullFluentIcons.otf#Seagull Fluent Icons");
