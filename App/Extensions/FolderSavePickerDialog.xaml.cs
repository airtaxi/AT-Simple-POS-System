...
{
    private const string SaveResource = "/FileSavePicker/FolderSavePickerSave";
    private const string CancelResource = "/FileSavePicker/FolderSavePickerCancel";
    private const string TitleResource = "/FileSavePicker/FolderSavePickerTitle";
    private const string FileNameResource = "/FileSavePicker/FolderSavePickerFileName";
    private const string PickFolderResource = "/FileSavePicker/FolderSavePickerPickFolder";
    private const string BrowseResource = "/FileSavePicker/FolderSavePickerBrowse";
    private const string FileTypeResource = "/FileSavePicker/FolderSavePickerFileType";
